...
<context>
You are filling out **"Traceability of Quality Requirements to Architectural Decisions:**  
...
<instructions>
- Add a new section "Traceability of Quality Requirements to Architectural Decisions" to `10_quality_requirements.adoc`.
</instructions>
...
<constraints>
- Use AsciiDoc tables for Coverage Matrix and Risk Alignment.  
...
<output>
Return ONLY the final Section 10.4 report in AsciiDoc.  
